...
namespace CafeMana.VIEW
{
    class ExportToExcel
    {
        ...
        internal static ExportToExcel Instance
        {
            get { if (_Instance == null) _Instance = new ExportToExcel(); return _Instance; }
            private set
            {
                _Instance = value;
            }
        ...
        public void Export(DataTable dt, string sheetName, string date)
        {
           ...
           // Tạo phần đầu nếu muốn
            ...
            head.Value2 = "DANH SÁCH HÓA ĐƠN "+date;
